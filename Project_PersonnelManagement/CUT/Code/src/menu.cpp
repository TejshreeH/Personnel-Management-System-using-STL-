 ...
 *
 * * DESCRIPTION   : This function displays various functions in the employee function
 *
...
void employee()
{
	...
	if(pass.compare("user@123")==0)
	{
		...
		int ech;
		string emp_ch;
		void(*choice1[4]) ()={addemp,editemp,viewemp,delemp};
		while(ech!=5)
		{
			cout<<"--------Employee Menu------------\n";
			cout<<"\n1.Add Employee\n2.Edit Employee\n3.View Employee\n4.Delete Employee\n5.Return to main menu\n";
...
void project()
{
	...
	if(pass.compare("user@456")==0)
	{
		...
		int pch=0;
		string proj_ch;
		void(*choice2[4]) ()={addproj,editproj,viewproj,delproj};
		while(pch!=5)
		{
			cout<<"--------project Menu------------\n";
			cout<<"\n1.Add project\n2.Edit project\n3.View project\n4.Delete project\n5.Return to main menu\n";
